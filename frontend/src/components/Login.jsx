...
const Login = ({ switchToRegister, switchToForgotPassword }) => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-slate-900 font-sans p-4 relative overflow-hidden">
            ...
            <div className="absolute top-[30%] right-[20%] w-[30vw] h-[30vw] rounded-full bg-indigo-500/5 blur-[100px] pointer-events-none"></div>

            {/* Main Interactive Login Card Container */}
            <div className="max-w-5xl w-full glass-panel rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col md:flex-row z-10 transition-all duration-300">

                {/* Left Side: Dynamic Showcase */}
                <div className="md:w-1/2 relative hidden md:flex flex-col justify-between p-12 overflow-hidden border-r border-white/10">
                    ...
                    <div className="absolute inset-0 bg-cover bg-center transition-transform duration-10000 hover:scale-105"
                        style={{ backgroundImage: "url('https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=1000&q=80')" }}></div>
                    ...
                    <div className="relative z-10 mt-auto text-left">
                        <h2 className="text-3xl font-extrabold text-white leading-tight mb-3">
                            Fuel Your Body, <br />
                            <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent text-glow">Transform Your Life</span>
                        </h2>
                        <p className="text-slate-300 text-sm max-w-sm leading-relaxed mb-6">
                            Tailored meal recommendations, AI chatbot guidance, and intuitive macronutrient tracking in one premium app.
                        </p>

                        {/* Interactive health stats indicator */}
                        <div className="flex gap-4 p-4 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 w-fit">
                            <div className="text-center px-2">
                                <span className="block text-xs text-slate-400">Tracked Meals</span>
                                <span className="text-lg font-bold text-emerald-400">100% Custom</span>
                            </div>
                            <div className="w-[1px] bg-white/10"></div>
                            <div className="text-center px-2">
                                <span className="block text-xs text-slate-400">Active Users</span>
                                <span className="text-lg font-bold text-teal-400">5,000+</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-full md:w-1/2 p-8 md:p-12 lg:p-16 flex flex-col justify-center bg-white/40 dark:bg-slate-950/20 backdrop-blur-md">
                        ...
                        <div className="space-y-1.5">
                            <div className="flex justify-between items-center ml-1">
                                ...
                                <button
                                    ...
                                    className="text-xs font-bold text-emerald-500 hover:text-emerald-400 hover:underline transition-colors"
                                >
                                    Forgot?
                                </button>
                            </div>
